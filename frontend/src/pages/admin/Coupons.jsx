        ...
        <div className="lg:col-span-1">
          <GlassCard className="p-6 border border-white/8 sticky top-24" hover={false}>
            <div className="flex items-center gap-2 mb-5">
              <Sparkles className="text-neon-red w-5 h-5" />
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              {success && (
                <div className="p-3 rounded-xl bg-gray-500/10 border border-gray-500/20 text-white400 text-xs flex items-center gap-2">
                        ...
                        <tr key={c._id} className="border-b border-white/5 hover:bg-white/1 transition-colors text-xs text-white/80">
                          ...
                          <td className="py-4 pl-4">
                            <div className="flex items-center gap-2.5">
                              <div className="p-2 rounded-xl bg-neon-red/10 border border-neon-red/20 text-neon-red shrink-0">
                                <Tag size={14} />
                              </div>
                          ...
                          {/* Discount */}
                          <td className="py-4 font-mono font-bold text-danger">
                            {c.discount}% OFF
                          </td>
                          ...
                          <td className="py-4">
                            <span className={`text-[9px] px-2 py-0.5 rounded-full font-bold uppercase tracking-wider font-mono ${
                              active
                                ? 'bg-gray-500/10 border border-gray-500/20 text-white400'
