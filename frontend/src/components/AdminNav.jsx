...
import { LayoutDashboard, Box, ShoppingCart, Tag, List } from 'lucide-react'
        ...
        return (
          <Link
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold transition-all border ${
              active
                ? 'bg-neon-red/10 border-neon-red/30 text-neon-red font-black shadow-[0_0_15px_rgba(184,51,255,0.15)]'
